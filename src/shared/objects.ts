...
export enum SA2Object {
    ...
    KDDRINGC = 'Shrine-activated circle of rings',
    KDDRINGL = 'Shrine-activated line of rings',
    ...
    PPSHED = 'House',
    PROPELLOR = 'Spinning fan on pole',
    PROPELLOR2 = 'Wall flower',
