...
export enum SA2Object {
    ...
    HAMMER2 = 'Rotating horizontal hexagon pillar',
    ...
    HATCH_A = 'Explodable hatch',
    HATCH_B = 'Explodable hatch (alternate)',
    ...
    LIGHT_SW = 'Light/Shaded area',
    LIGHT_SW_F = 'Light/Shaded area area large draw distance',
    LIGHTBAR = 'Glowing orange light row',
    LIGHTEFF = 'Pixel lighting effect',
    LIGHTW = 'Quadruple runway light',
    ...
    ORE = 'Crystal',
    ORI = 'Cage',
    PAINTING = 'Non-warp wall painting',
    PALM = 'Palm tree',
    PANEL = 'Floor panel',
    PANELAREA = 'Floor/block indicator',
    PIC = 'Holdable stage object',
    ...
    ROADOBJ = 'Prop',
    ROBJ = 'Road object',
    ROBJ_M = 'Road object medium draw distance',
    ROBJ_S = 'Road object short draw distance',
    ROCK = 'Floating rock',
    ...
    STOPLOCKON = 'Homing attack target/Mech lock-on blocker',
